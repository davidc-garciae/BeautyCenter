-- CreateEnum
CREATE TYPE "Enum_RoleName" AS ENUM ('ADMIN', 'USER', 'STAFF');
...
CREATE TABLE "SystemConfig" (
    ...
    "workingDaysEnd" INTEGER NOT NULL DEFAULT 6,
    "businessName" TEXT NOT NULL DEFAULT 'Centro de Belleza',
    "businessPhone" TEXT,
    "businessEmail" TEXT,
...
-- AddForeignKey
ALTER TABLE "WorkingHours" ADD CONSTRAINT "WorkingHours_staffId_fkey" FOREIGN KEY ("staffId") REFERENCES "User"("id") ON DELETE SET NULL ON UPDATE CASCADE;
